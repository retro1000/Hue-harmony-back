...
//                .cors(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests((auth) -> auth
                    .requestMatchers("/login/validate", "/customize/banners", "/user/signup", "product/create","purchase-order/**","grn/**","/product/delete","/pos/**","/product/delete","product/view/**","/product/**").permitAll()

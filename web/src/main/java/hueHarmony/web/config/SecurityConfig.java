...
//                .cors(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests((auth) -> auth
                    .requestMatchers("/users/create", "/login/validate", "/customize/banners", "/users/signup", "/product/create","/product/delete","product/view/**","/product/**", "/orders/**", "/webhook", "cart/**", "supplier/**","/wholesalecustomer/**").permitAll()
